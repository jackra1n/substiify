...
class CustomLogFormatter(logging.Formatter):
    ...
    FORMATS = {
        ...
        logging.WARNING: format_prefix + yellow + level_name + format_suffix,
        logging.ERROR: format_prefix + red + level_name + format_suffix,
        logging.CRITICAL: format_prefix + bold_red + level_name + format_suffix
    }
